...
from app.lector.lector.parsers.comicbooks import ParseCOMIC
...
if mupdf_check:
    from app.lector.lector.parsers.pdf import ParsePDF
    sorter['pdf'] = ParsePDF
else:
...
if djvu_check:
    from app.lector.lector.parsers.djvu import ParseDJVU
...
if markdown_check:
    from app.lector.lector.parsers.markdown import ParseMD
    sorter['md'] = ParseMD
else:
...
if lxml_check and xmltodict_check:
    from app.lector.lector.parsers.epub import ParseEPUB
    from app.lector.lector.parsers.mobi import ParseMOBI
    from app.lector.lector.parsers.fb2 import ParseFB2
...
if textile_check:
    from app.lector.lector.parsers.txt import ParseTXT
    sorter['txt'] = ParseTXT
else:
